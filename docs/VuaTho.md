...
VUA THỢ
Nền tảng kết nối thợ nghề & khách hàng

TÀI LIỆU MÔ TẢ DỰ ÁN & ĐẶC TẢ YÊU CẦU CHỨC NĂNG

Phiên bản: 1.0
Ngày: Tháng 05/2026
Công nghệ: .NET Core · Next.js
 
1. MÔ TẢ DỰ ÁN
1.1. Tổng quan
...
 
8. LỘ TRÌNH PHÁT TRIỂN (MVP)

Giai đoạn	Thời gian	Nội dung
Phase 1	Tháng 1 – 2	Thiết lập kiến trúc, Auth Service, User Service, DB schema, CI/CD pipeline cơ bản.
Phase 2	Tháng 3 – 4	Client 1: đăng ký thợ, hồ sơ, admin duyệt. Client 2: đăng ký khách, tìm kiếm thợ.
Phase 3	Tháng 5 – 6	Booking Service hoàn chỉnh, Payment Service, thông báo real-time, chat.
Phase 4	Tháng 7 – 8	Review & Rating, Ví thợ, báo cáo Admin, voucher, tối ưu hiệu năng.
Phase 5	Tháng 9	UAT, kiểm thử bảo mật (Pentest), soft launch beta, thu thập phản hồi.
Launch	Tháng 10	Chính thức ra mắt, marketing, onboard thợ đầu tiên theo khu vực thí điểm.
